...
> **状态：** 学习参考（不照搬）  
> **整理日期：** 2026-08-11  
> **相关：** [`SITE_POSITIONING_MEMO.md`](./SITE_POSITIONING_MEMO.md) · [`GROWTH_PORTAL_NAMING.md`](./GROWTH_PORTAL_NAMING.md) · [`ARCHITECTURE_DECISION_MEMO.md`](./ARCHITECTURE_DECISION_MEMO.md) · [`OPERATIONS_MANUAL.md`](./OPERATIONS_MANUAL.md) · [`DUAL_REPO_WORK_GUIDE.md`](./DUAL_REPO_WORK_GUIDE.md)
